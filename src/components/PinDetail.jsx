      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
            ...
            <div className="flex gap-2 items-center">
              <a
                ...
                className="bg-white w-9 h-9 rounded-full flex items-center 
                  justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none transition-all duration-500 ease-in-out"
              >
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">{pinDetail.about}</p>
          </div>
